...
function Listhistorysoftwaresupportapplication_staff() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (text, record) => record.employee.username,
    },
    {
      title: "Description",
    ...
    },
    {
      ...
      render: (text, record) => (
        <>
          <Popconfirm
            title="Are you sure you want to delete this appliaction"
            onConfirm={() => handleDelete(record.softwareSupportApplicationId)}
            okText="Yes"
            cancelText="No"
          >
